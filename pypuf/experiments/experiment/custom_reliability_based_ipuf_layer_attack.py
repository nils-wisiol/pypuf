...
class ExperimentCustomReliabilityBasedLayerIPUF(Experiment):
    ...
    def generate_unreliable_challenges_for_layer(self):
        ...
        idx_heuristic = s if self.heuristic[1] == 2 else s_swap if self.heuristic[0] == 2 else logical_and(s, s_swap)
    ...
    def generate_reliable_challenges_for_layer(self):
        ...
        idx_heuristic = s if self.heuristic[3] == 2 else s_swap if self.heuristic[2] == 2 else logical_and(s, s_swap)
