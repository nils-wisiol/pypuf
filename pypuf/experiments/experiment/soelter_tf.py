...
from pypuf.learner.regression.soelter-learner import NeuralRegression
...
class TestSoelter(Experiment):

    def __init__(self, progress_log_prefix, parameters):

        progress_log_name = None if not progress_log_prefix else 'NEURALREGRESSION_k{}_n{}'.format(parameters.k, parameters.n)
    ...
    def prepare(self):
        ...
        self.learner = NeuralRegression(self.train_set, self.valid_set,
